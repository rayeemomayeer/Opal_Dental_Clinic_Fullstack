...
export const metadata: Metadata = {
  title: "Gallery — Opal Dental Clinic & Implant Centre",
  description: "A look inside Opal Dental Clinic — our facilities, technology, and care environment.",
};
    ...
    <main className="bg-opal-gradient flex min-h-screen flex-col items-center justify-center px-6">
      ...
      <div className="text-center">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(11,79,125,0.8) 0%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        ...
        <p className="relative mt-6 text-base leading-relaxed text-foreground/55">
          Our gallery is being curated. Check back soon for a full visual tour of Opal Dental Clinic.
        </p>
      </div>
    </main>
  );

...
export const metadata: Metadata = {
  title: "Dr. Nadia — Opal Dental Clinic & Implant Centre",
  description: "Cosmetic Dentist at Opal Dental Clinic & Implant Centre, Chattogram.",
};

export default function DrNadiaPage() {
  return (
    <main className="bg-opal-gradient flex min-h-screen flex-col items-center justify-center px-6">
      ...
      <div className="text-center">
        ...
        <p className="relative mt-6 text-base leading-relaxed text-foreground/55">
          Dr. Nadia&apos;s profile page is being prepared. Check back soon.
        </p>
      </div>
    </main>
  );
